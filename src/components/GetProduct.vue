    ...
    <div class="columns is-centered is-multiline">
      <div class="column is-5" :key="key" v-for="(Product, key) in Products">
        <div class="card widthcard is-centered">
          ...
          <div class="card-content" v-if="key === updateKey">
            <div>
              <div class="title is-4 has-text-left">ชื่อสินค้า<input v-model="updateName" class="input is-focused" type="text" placeholder="Edit Name">
              </div>
              <div class="columns">
                <span class="column title is-6 has-text-left has-text-danger">ราคา <input v-model="updatePrice" class="input is-focused" type="number" placeholder="Edit Price">
                </span>
                <span class="column title is-6 has-text-right">จำนวน <input v-model="updateAmount" class="input is-focused" type="number" placeholder="Edit Amount" max="10" min="1">
                </span>
              </div>
            </div>
          </div>
